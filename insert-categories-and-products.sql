...
('MacBook Pro 14 M3', 'MacBook Pro 14 inch với chip M3, RAM 16GB, SSD 512GB', 4500, 10, 1, 1),
('Dell XPS 13', 'Dell XPS 13 inch, Intel Core i7, RAM 16GB, SSD 512GB', 3200, 15, 1, 1),
('Lenovo ThinkPad X1', 'Lenovo ThinkPad X1 Carbon Gen 11, Intel Core i7, RAM 16GB', 3500, 8, 1, 1),
('HP Pavilion 15', 'HP Pavilion 15 inch, AMD Ryzen 5, RAM 8GB, SSD 256GB', 1800, 20, 1, 1),
('ASUS ROG Strix G15', 'ASUS ROG Gaming Laptop, RTX 4060, Intel Core i7, RAM 16GB', 3800, 5, 1, 1),

-- Điện thoại (category_id = 2)
('iPhone 15 Pro Max', 'iPhone 15 Pro Max 256GB, Titan Tự nhiên', 3300, 25, 2, 1),
('Samsung Galaxy S24 Ultra', 'Samsung Galaxy S24 Ultra 256GB, Màu Đen', 2800, 30, 2, 1),
('Xiaomi 14 Pro', 'Xiaomi 14 Pro 256GB, Màu Trắng', 1800, 40, 2, 1),
('OPPO Find X7', 'OPPO Find X7 256GB, Màu Xanh', 1500, 35, 2, 1),
('Google Pixel 8 Pro', 'Google Pixel 8 Pro 256GB, Màu Đen', 2200, 15, 2, 1),

-- Tablet (category_id = 3)
('iPad Pro 12.9', 'iPad Pro 12.9 inch M2, 256GB, WiFi', 2800, 12, 3, 1),
('Samsung Galaxy Tab S9', 'Samsung Galaxy Tab S9 256GB, WiFi', 1800, 18, 3, 1),
('iPad Air', 'iPad Air 10.9 inch M1, 128GB, WiFi', 1500, 20, 3, 1),
