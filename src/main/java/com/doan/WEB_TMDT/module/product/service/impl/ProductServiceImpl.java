...
public class ProductServiceImpl implements ProductService {
    ...
    public ApiResponse getProductQuantity(Long productId) {
        ...
        long available = serialRepo.countByProductAndStatus(product, SerialStatus.AVAILABLE);
        long sold = serialRepo.countByProductAndStatus(product, SerialStatus.SOLD);
        long returned = serialRepo.countByProductAndStatus(product, SerialStatus.RETURNED);
