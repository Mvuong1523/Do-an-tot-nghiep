...
export default function ExportDetailPage() {
  ...
  const loadOrderDetail = async () => {
    try {
      ...
      if (response.success) {
        ...
        router.push('/employee/warehouse/export/list')
      }
    } catch (error) {
  ...
  return (
    <div>
      <div className="mb-6">
        <Link
          href="/employee/warehouse/export/list"
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-amber-700 mt-1">
                Bạn có thể xem chi tiết phiếu xuất, nhưng không thể duyệt phiếu xuất. Chỉ nhân viên kho mới có quyền này.
              </p>
            </div>
          </div>
        </div>
