  ...
  const modules = [
    {
      ...
      icon: FiFileText,
      href: '/employee/accounting/transactions',
      color: 'blue'
    },
    {
      title: 'Kỳ kế toán',
      ...
      icon: FiCalendar,
      href: '/employee/accounting/periods',
      color: 'green'
    },
    {
      title: 'Quản lý thuế',
    ...
    },
    {
      ...
      icon: FiBarChart,
      href: '/employee/accounting/advanced-reports',
      color: 'purple'
    },
    {
      ...
      icon: FiTruck,
      href: '/employee/accounting/shipping',
      color: 'red'
    }
  ]
