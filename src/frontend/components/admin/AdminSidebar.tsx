...
const menuItems: MenuItem[] = [
  ...
  { 
    ...
    children: [
      ...
      { icon: FiDollarSign, label: 'Đối soát', href: '/admin/accounting/reconciliation' },
      { icon: FiDollarSign, label: 'Công nợ NCC', href: '/admin/accounting/payables' },
      { icon: FiDollarSign, label: 'Giao dịch', href: '/admin/accounting/transactions' },
      { icon: FiDollarSign, label: 'Báo cáo', href: '/admin/accounting/reports' },
      ...
      { icon: FiDollarSign, label: 'Thuế', href: '/admin/accounting/tax' },
      { icon: FiDollarSign, label: 'Vận chuyển', href: '/admin/accounting/shipping' },
      { icon: FiDollarSign, label: 'Tài khoản ngân hàng', href: '/admin/bank-accounts' },
    ]
  },
